    ...
    public OptionMenu moveControlCardToStackFamilyCards() {
        ...
        do {
            ...
            if ((readIOS >= 1) && (readIOS < 5)) {
                ...
                if (this.actionMoveCardController.moveCardToStackFamilyCards(origin, board.getStackFamilyCards().get(position).getCards(), card)) {
    ...
    public OptionMenu controlMoveCardToLadder() {
        ...
        do {
            ...
            if ((readIOS >= 1) && (readIOS < 8)) {
                    ...
                    List<Card> destinLadder=board.getLadders().getLadders().get(position).getSatckCards();
